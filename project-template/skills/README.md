...
This directory contains comprehensive guides and cheat sheets for the development tools used in the {{PROJECT_NAME}} project.
...
4. **Update Examples**: Ensure {{PROJECT_NAME}} examples remain relevant
...
3. Include {{PROJECT_NAME}}-specific examples
